...
<pre><code class="language-bash">curl -X POST \
    "http://localhost:8000/api/workshop/login?username=rem&amp;password=saepe" \
...
<pre><code class="language-bash">curl -X POST \
    "http://localhost:8000/api/provider/login?username=omnis&amp;password=pariatur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"</code></pre>
<pre><code class="language-javascript">const url = new URL(
...
<pre><code class="language-bash">curl -X POST \
    "http://localhost:8000/api/provider/tickets/create?driver_id=cum&amp;workshop_id=dolorem&amp;reason_id=incidunt" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"</code></pre>
<pre><code class="language-javascript">const url = new URL(
...
<pre><code class="language-bash">curl -X GET \
    -G "http://localhost:8000/api/provider/tickets/remove/quis" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/provider/tickets/remove/quis"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "http://localhost:8000/api/workshop/tickets/resolve/blanditiis" \
    -H "Authorization: Bearer {YOUR_AUTH_KEY}" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/workshop/tickets/resolve/blanditiis"
);
